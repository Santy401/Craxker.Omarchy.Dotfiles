...
# Coordenadas Bogotá, Colombia
LATITUDE = "4.7110"
LONGITUDE = "-74.0721"

def get_prayer_times():
    today = datetime.date.today().strftime("%d-%m-%Y")
    # Aladhan API - Method 3 (ISNA) para Colombia
    url = f"https://api.aladhan.com/v1/timings/{today}?latitude={LATITUDE}&longitude={LONGITUDE}&method=3"
    try:
